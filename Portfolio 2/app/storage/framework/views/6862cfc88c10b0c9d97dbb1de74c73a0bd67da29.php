...
<html lang="en">
	<head>
        ...
        <noscript>
            <link rel="stylesheet" href="<?php echo e(asset('css/skel.css')); ?>" />
            <link rel="stylesheet" href="<?php echo e(asset('css/style.css')); ?>" />
            <link rel="stylesheet" href="<?php echo e(asset('css/style-xlarge.css')); ?>" />
        </noscript>
	</head>
	<body class="landing">
		...
		<!-- Header -->
			<header id="header">
				<h1><a href= "<?php echo e(URL::route('home')); ?>" >Hit Up</a></h1>
				<nav id="nav">
					<ul>
						<li><a href="<?php echo e(URL::route('home')); ?>">Home</a></li>
						<li><a href="<?php echo e(URL::route('generic')); ?>">Service One</a></li>
						<li><a href="<?php echo e(URL::route('elements')); ?>">Service Two</a></li>
		...
		<section id="one" class="wrapper style1 special">
				<div class="container">
					<header class="major">
						...
						<p>Can't find your campus? <a href="<?php echo e(URL::route('generic')); ?>">Submit</a> a request!</p>
					</header>
					<div class="row 150%">
						<div class="4u 12u$(medium)">
							<section class="box">
								<a href="<?php echo e(URL::route('college',['id' => 'UMN'])); ?>"><i class="icon big rounded color6 fa-university"></i></a>
								<h3><a href="<?php echo e(URL::route('college',['id' => 'UMN'])); ?>">University of Minnesota</a></h3>
							</section>
						</div>
						<div class="4u 12u$(medium)">
							<section class="box">
								<a href="<?php echo e(URL::route('college',['id' => 'ISU'])); ?>"><i class="icon big rounded color7 fa-university"></i></a>
								<h3><a href="<?php echo e(URL::route('college',['id' => 'ISU'])); ?>">Iowa State </br> Universty</a></h3>
							</section>
						</div>
						<div class="4u$ 12u$(medium)">
							<section class="box">
								<a href="<?php echo e(URL::route('college',['id' => 'UND'])); ?>"><i class="icon big rounded color10 fa-university"></i></a>
								<h3><a href="<?php echo e(URL::route('college',['id' => 'UND'])); ?>">University of North Dakota</a></h3>
							</section>
						</div>
					</div>
				</div>
